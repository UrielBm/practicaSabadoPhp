...
$practica = Practicas::obtenerPractica($idPractica, $conexion)
...
<div class="row">
    <div class="col-5 mb-1">
        <div class="d-flex justify-content-between align-items-baseline">
            <p>Editar practica de laboratorio</p>
            <a href="./practicas.php" class="btn btn-outline-success"><i class="fas fa-eye"></i> Ver mis practicas</a>
        </div>
    </div>
</div>
<form class="form" id="registerPracticas" action="./views/practicas/edit_practica.php" method="POST">
    <input type="hidden" name="id" value="<?php echo base64_encode($practica->id) ?>" />
    <div class="form-row">
        <div class="form-group col-md-4">
            <label for="nombrePractica">Nombre</label>
            <input type="text" class="form-control" placeholder="Nombre de la practica" name="editNombrePractica" id="nombrePractica" value="<?php echo $practica->nombre ?>">
            <div class="text-danger font-italic fontSmall d-none" id="errorNombrePracticaForm"></div>
        </div>
    </div>
    <div class="form-group">
        <label for="description">Descripción</label>
        <textarea class="form-control" rows="4" placeholder="Descrición de la practica" name="description" id="descriptionFormPractica"><?php echo $practica->descripcion ?></textarea>
